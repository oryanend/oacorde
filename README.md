...
O **Acorde** é um **site** que tem como **objetivo** fornecer ao **usuário** uma **plataforma** onde seja possível consultar **acordes** montados a partir das **notas** selecionadas pelo próprio usuário, por meio de uma ​**interface interativa**​, além de apresentar **progressões** como forma de ​**auxílio**​.
...
Este é o modelo conceitual do sistema "O Acorde". Ele representa as  principais entidades e seus relacionamentos, servindo como base para a  construção do banco de dados e das classes de domínio da aplicação.

<p align="center">
  <img src="docs/class-diagram-oacorde.jpg" alt="Modelo conceitual">
</p>
...
<p align="center">
  <img src="docs/use-case-oacorde.jpg" alt="Modelo conceitual">
</p>
